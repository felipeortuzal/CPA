...
select 'CPA',null,'1.2',pd_code,title,item_type,
  case when pd_code='2' then 40 else null end,sort_order,
...
where child.certification_id='CPA' and parent.certification_id='CPA'
  and child.pd_code like '2.%'
  and parent.pd_code=regexp_replace(child.pd_code,'\.[^.]+$','');
update public.curriculum_items set parent_id=null where certification_id='CPA' and pd_code='2';
